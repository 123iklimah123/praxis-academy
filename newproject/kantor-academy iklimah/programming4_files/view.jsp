...
usi_js.display_vars.p1_html = [
	...
	'<div class="usi_sr_only">Get 10 free images now. Try the 10 images per month plan for free. Pay just $29/mo after your trial ends. If you cancel in the 1st month you pay nothing!</div>',
].join('');
